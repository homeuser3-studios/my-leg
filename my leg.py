...
myleg = ["You jumped off a building and landed on your feet. 'MY LEG!'", "Someone drove over your leg. 'MY LEG!'", "You were in your car and you got a headon collision. Your leg went down too far... 'MY LEG!'", "You were in a shark cage and your feet went through one of the squares for a second. 'MY LEG!'", "A bull ran right at you and flipped you, and then you landed standing up. 'MY LEG!'", "You were walking past a dog who's nails hadn't been cut in 2 years, and then they scratched your leg. 'MY LEG!'"]

myhead = ["You were staring at the ground while running and you hit your head on the wall. 'MY HEAD!'", "You were jumping off a very high diving board into a pool and went head first into the shallow area. 'MY HEAD!'", "You were on a beach and were right on the cliff in the ocean where the water gets very deep. You dived into the cliff and accidentally hit the bottom. 'MY HEAD!'", "Someone slammed a pot on your head. 'MY HEAD!'", "A UFO came and crashed on your head. 'MY HEAD!'"]
